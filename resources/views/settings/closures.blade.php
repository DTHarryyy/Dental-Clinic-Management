@extends('layouts.app')
@section('page_title', 'Settings - Closures')

@section('content')
<div class="mb-6"><h1 class="page-title">Settings</h1><p class="page-subtitle">Block dates or partial-day ranges from booking.</p></div>
<div class="grid grid-cols-1 gap-6 xl:grid-cols-4">
    ...
    <div class="xl:col-span-3 space-y-5">
        <div class="responsive-card responsive-card-padding">
            ...
            <form action="{{ route('settings.closures.store') }}" method="POST" class="mt-4 grid gap-4 sm:grid-cols-2 lg:grid-cols-5">@csrf
