@extends('layouts.app')
@section('page_title', 'Invite User')
...
<div class="flex items-center gap-2 text-sm text-slate-500 mb-5">
    ...
    <span>/</span>
    <span class="text-slate-800 font-medium">Invite User</span>
</div>

<div class="flex items-center justify-between mb-6">
    <h1 class="text-2xl font-bold text-slate-800">Invite Staff Member</h1>
            ...
            <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" placeholder="Reyes" class="w-full px-4 py-2.5 rounded-xl border border-slate-200 bg-slate-50 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-200 focus:border-emerald-400 transition" />
                    </div>
                    <div class="sm:col-span-2">
                        <label class="block text-sm font-medium text-slate-700 mb-1.5">Email Address <span class="text-red-500">*</span></label>
                        <input type="email" placeholder="staff@dentalcare.com" class="w-full px-4 py-2.5 rounded-xl border border-slate-200 bg-slate-50 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-200 focus:border-emerald-400 transition" />
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" placeholder="e.g. 0012345" class="w-full px-4 py-2.5 rounded-xl border border-slate-200 bg-slate-50 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-200 focus:border-emerald-400 transition" />
                    </div>
                </div>
            </div>
        ...
        <div class="space-y-5">
            ...
            <div class="bg-blue-50 border border-blue-100 rounded-2xl p-4">
                <div class="flex items-start gap-2">
                    ...
                    <p class="text-xs text-blue-700">An invitation email will be sent to the user. They will set their own password upon first login.</p>
                </div>
            </div>
            ...
            <div class="flex flex-col gap-3">
                ...
                <button type="submit" class="w-full py-3 rounded-xl bg-emerald-500 hover:bg-emerald-600 text-white font-semibold text-sm transition shadow-sm">
                    <i class="fa-solid fa-paper-plane mr-1"></i> Send Invitation
                </button>
            </div>
        </div>
    </div>
